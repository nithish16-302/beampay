...
class BeamEmailConfirmationFormComponent {
    ...
    getUuid() {
        var _a, _b, _c;
        console.log((_a = this.authForm.get('email')) === null || _a === void 0 ? void 0 : _a.value);
        this.loading = true;
        console.log(this.terminalKey);
        console.log(this.amount);
        this.beampayPluginService.loginWithOtp({ email: (_b = this.authForm.get('email')) === null || _b === void 0 ? void 0 : _b.value, pinCode: (_c = this.authForm.get('pinCode')) === null || _c === void 0 ? void 0 : _c.value }).subscribe((res) => {
            console.log(res);
    ...
    joinConversation(fundingSourceUuid, authToken) {
        ...
        const request = {
            ...
            "pinCode": (_a = this.authForm.get('pinCode')) === null || _a === void 0 ? void 0 : _a.value,
